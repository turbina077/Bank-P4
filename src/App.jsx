                ...
                <>
                  ...
                  <div className="p-4 border-b-2 flex items-center justify-between" style={{borderColor: theme.secondary, background: theme.light}}>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-xs" style={{color: theme.secondary}}>YOUR POSITION</div>
                        <div className="text-2xl font-bold" style={{color: theme.accent, fontFamily: FONT_DISPLAY}}>#{myRank}</div>
                      </div>
                    </div>
